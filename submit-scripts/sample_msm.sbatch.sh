...
#################
#set a job name  
#SBATCH --job-name=sample_msm
#################  
#a file for job output, you can check job progress, append the job ID with %j to make it unique
#SBATCH --output=/scratch/users/cachoe/job_outputs/sample_msm.%j.out
#################
# a file for errors from the job
#SBATCH --error=/scratch/users/cachoe/job_outputs/sample_msm.%j.err
#################
...
python sample_msm.py -num_clusters 400 -dataset apo_calmodulin
source deactivate